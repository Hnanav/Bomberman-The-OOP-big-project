        ...
        if (level <= 10) {
            ...
            while (count > 0) {
                ...
                if (type == 1 || type == 2) {
                    count --;
                    arr[type]++;
                    if (arr[1] >= (5 + (level + 1) % 10 * 5 + Enemy * 5)) return 1;
                    if (arr[2] >= (35 + (level + 1) % 10 * 5 + Enemy * 5)) return 2;
                }
            }
            return 2;
        }
        if (level <= 50) {
            ...
            while (count > 0) {
                ...
                if (type == 1 || type == 2 || type == 3) {
                    count --;
                    arr[type]++;
                    if (arr[1] >= (55 + (level + 1) % 10 * 2 + Enemy * 2)) return 1;
                    if (arr[2] >= (35 + (level + 1) % 10 * 2 + Enemy * 2)) return 2;
                    if (arr[3] >= (15 + (level + 1) % 10 * 2 + Enemy * 2)) return 3;
                }
            }
            return 1;
        }
        if (level <= 30) {
            ...
            while (count > 0) {
                ...
                if (type == 1 || type == 2 || type == 3) {
                    count --;
                    arr[type]++;
                    if (arr[1] > (65 + (level + 1) % 10 * 2 + Enemy * 2)) return 1;
                    if (arr[2] > (45 + (level + 1) % 10 * 2 + Enemy * 2)) return 2;
                }
            }
            return 3;
        }
        ...
        if (level <= 50) {
            ...
            while (count > 0) {
                ...
                if (type == 1 || type == 2 || type == 3) {
                    count --;
                    arr[type]++;
                    if (arr[1] > (75 + (level + 1) % 10 * 2) + Enemy * 2) return 1;
                    if (arr[2] > (55 + (level + 1) % 10 * 2) + Enemy * 2) return 2;
                }
            }
            return 3;
        }
