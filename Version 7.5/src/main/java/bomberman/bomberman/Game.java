...
import static bomberman.bomberman.Algorithm.CheckCollision.*;
import bomberman.bomberman.Algorithm.*;
import bomberman.bomberman.Entities.Background.*;
import bomberman.bomberman.Entities.BombExplosion.*;
import bomberman.bomberman.Entities.Static.*;
import bomberman.bomberman.Entities.Bomb.*;
import bomberman.bomberman.Entities.Dynamic.*;
import bomberman.bomberman.Entities.Item.*;
