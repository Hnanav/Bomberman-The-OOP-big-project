...
public class BombExplosion extends Entity{
    ...
    public void getPoles() {
        ...
        for (int i = 1; i <= level; i++) {
            ...
            else if (map[vtY][x1] == 'W') {
                left_pole = (x1 + 1) * tileSize;
                break;
            }
            else if (map[vtY][x1] == 'B') {
                left_pole = (x1 + 1) * tileSize;
        ...
        for (int i = 1; i <= level; i++) {
            ...
            else if (map[vtY][x2] == 'W') {
                right_pole = (x2 - 1) * tileSize;
                break;
            }
            else if (map[vtY][x2] == 'B') {
                right_pole = (x2 - 1) * tileSize;
        ...
        for (int i = 1; i <= level; i++) {
            ...
            else if (map[y1][vtX] == 'W') {
                up_pole = (y1 + 1) * tileSize;
                break;
            }
            else if (map[y1][vtX] == 'B') {
                up_pole = (y1 + 1) * tileSize;
        ...
        for (int i = 1; i <= level; i++) {
            ...
            else if (map[y2][vtX] == 'W') {
                down_pole = (y2 - 1) * tileSize;
                break;
            }
            else if (map[y2][vtX] == 'B') {
                down_pole = (y2 - 1) * tileSize;
